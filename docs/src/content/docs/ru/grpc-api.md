---
title: gRPC обработка изображений
description: gRPC API для потоковой обработки и трансформации изображений любого размера без полной буферизации в памяти.
group: Transports
order: 2
---

# gRPC обработка изображений
